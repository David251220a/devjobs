                ...
                <div class="flex items-center justify-around">
                    ...
                    <nav class="flex-1 text-right">
                        ...
                        @else
                            ...
                            class="bg-teal-500 rounded-full mr-3 px-3 py-2 font-bold text-sm">
                                {{ Auth::user()->unreadNotifications->count() }}
                            </a>

                            <a class="text-gray-300 no-underline hover:underline hover:text-gray-300 p-3" href="{{ route('logout') }}"
