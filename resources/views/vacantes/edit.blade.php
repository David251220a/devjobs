...
@section('content')
    ...
    <form class="max-w-lg mx-auto my-10" action="{{ route('vacantes.update', $vacante) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="mb-5">
            ...
            @error('titulo') border-red-500 border @enderror" name="titulo" value="{{ old('titulo', $vacante->titulo) }}" autofocus>
            @error('titulo')
        ...
        <div class="mb-5">
            ...
            p-3 bg-gray-100">
                ...
                @foreach ($categorias as $categoria)
                    <option
                    {{ old('categoria', $vacante->categoria->id) == $categoria->id ? 'selected' : ''}}
        ...
        <div class="mb-5">
            ...
            p-3 bg-gray-100">
                ...
                @foreach ($experiencias as $experiencia)
                    <option
                    {{ old('experiencia', $vacante->experiencia->id) == $experiencia->id ? 'selected' : ''}}
        ...
        <div class="mb-5">
            ...
            p-3 bg-gray-100">
                ...
                @foreach ($ubicaciones as $ubicacion)
                    <option
                    {{ old('ubicacion', $vacante->ubicacion->id) == $ubicacion->id ? 'selected' : ''}}
        ...
        <div class="mb-5">
            ...
            p-3 bg-gray-100">
                ...
                @foreach ($salarios as $salario)
                    <option
                    {{ old('salario', $vacante->salario->id) == $salario->id ? 'selected' : ''}}
