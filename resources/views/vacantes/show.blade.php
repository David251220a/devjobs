...
@section('styles')
    ...
    integrity="sha512-ZKX+BvQihRJPA8CROKBhDNvoc2aDMOdAlcm7TUQY+35XYtrd3yh95QOOhsPDQY9QnKE0Wqag9y38OIgEvb88cA==" crossorigin="anonymous" 
...
@section('content')
    ...
    <div class="mt-10 mb-20 md:flex items-start">
        ...
        <div class="md:w-3/5">
            ...
            <h2 class="text-2xl text-center text-gray-700 mb-6">Conocimiento y Tecnologias</h2>
            @php
